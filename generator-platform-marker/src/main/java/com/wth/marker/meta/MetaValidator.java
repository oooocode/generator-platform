...
import com.wth.marker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillFileConfig(Meta meta) {
        ...
        if (!CollectionUtil.isNotEmpty(fileInfoList)) {
            throw new MetaException("未填写 files");
        }
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "name");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.wth");
